...
//        GlStateManager.scale(1F, 1F, 1F);
        ...
        while (e.hasMoreElements()) {
            ...
            if (blockToHighlight.renderUntilTime < cur_time
                ...
                renderBlockOutlineAt(blockToHighlight.pos, event.getPartialTicks(),
    ...
    private void renderBlockOutlineAt(BlockPos pos,float partialticks, int color) {
        renderBlockOutlineAt(pos,partialticks, color, 1F);
    }

    private void renderBlockOutlineAt(BlockPos pos, float partialticks, int color, float thickness) {
